export const projectsData = [
  ...
  },
  {
    ...
    description: "Designed and developed an interactive virtual experiment for C-DAC, enabling school students to perform science experiments online through engaging, animation-based simulations, making STEM learning accessible and fun.",
...
export const workExperience = [
  {
    id: 1,
    title: "Research and Development Outhouse Project",
